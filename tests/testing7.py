# AI vs AI without alpha-beta pruning on a 3x3 board
...
class AI:
    def __init__(self, level=1, player=2 or 1):
        self.level = level
        self.player = player
    ...
    def eval(self, game_board, player):
        ...
        if player == 1:
            ai_eval, move = self.minimax(game_board, True)
        else:
...
class Game:
    ...
    def draw_fig(self, row, col):
        if self.player == 1:
            bee = pygame.image.load('/Users/kelseecarmichael/PycharmProjects/TicTacToe/Images/husky.png')
            bee.convert()
            ...
            flower = pygame.image.load('/Users/kelseecarmichael/PycharmProjects/TicTacToe/Images/cat.png')
            flower.convert()
